...
export async function POST(req: Request) {
  try {
    ...
    // If Gemini is unavailable/rate-limited, return a transient error.
    // The client should keep the user's form inputs and prompt them to retry shortly.
      ...
      return NextResponse.json(
        {
          error:
            mockedReason ??
            "High demand request. Please retry after a while.",
